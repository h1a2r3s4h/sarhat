...
export default function SolutionsGrid() {
  ...
  return (
    <section id="solutions" className="py-28 bg-black relative z-10 border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div>
              ...
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif-display font-medium text-white tracking-tight leading-tight">
                Six capabilities. <br />
                <span className="text-zinc-400 font-normal">One connected way to build.</span>
              </h2>
            </div>
        ...
        {/* Capabilities Stacking & Grid with Scroll Reveals */}
